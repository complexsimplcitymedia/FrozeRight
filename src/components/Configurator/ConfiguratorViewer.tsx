  ...
  return (
    <div className="relative aspect-w-16 bg-black rounded-lg overflow-hidden">
      ...
      <div className="absolute bottom-4 left-4 right-4 flex items-center justify-center">
        <p className="text-xs bg-yellow-500/20 text-yellow-300 px-4 py-2 rounded-lg max-w-md text-center">
          AI models are capable of giving incorrect information. Always double check when in doubt, and even where you're not is a good practice.
        </p>
      </div>
